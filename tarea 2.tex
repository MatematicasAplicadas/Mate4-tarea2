...
\begin{document}
    ...
    \begin{enumerate}
        ...
        \item {
            ...
            $\Psi(t)=(A_0+A_1t+A_2t^2)e^{7t}$, siempre y cuando $e^{7t}$ no sea una solución
            ...
            \begin{align*}
                ...
                &= \left[49A_0+14A_1+2A_2+(49A_1+28A_2)t+49A_1t^2\right]e^{7t}
            \end{align*}
            Sustituyendo en la ecuación diferencial tendremos:
            \begin{equation*}
                \left[
                    49A_0+14A_1+2A_2+(49A_1+28A_2)t+49A_1t^2
                    +5(7A_0+A_1+(7A_1+2A_2)t+7A_2t^2)
                \right]e^{7t} = t^2e^{7t}
            \end{equation*}
            es decir
            \begin{equation*}
                84A_0+19A_1+2A_2+(84A_1+38A_2)t+(49A_1+35A_2)t^2=0+0\cdot t+t^2
            \end{equation*}
            por lo que
            \begin{equation*}
                \begin{cases}
        ...
        \item {
            ...
            \begin{align*}
                ...
                3C_1-C_2 &= \frac{7}{3}
            \end{align*}
            Sumamnos ambas ecuaciones para obtener que $4C_1=\frac{12}{3}=4$, entonces $C_1=1$ y como $1+C_2=\frac{5}{3}$ tenemos que $C_2=\frac{2}{3}$. Por lo tanto, la solución de la ecuación con condiciones iniciales es
